...
describe('Diameter Dim', () => {
  ...
  it('can output an svg', () => {
    ...
    expect(path).to.eql('M -3.5355339059327378 -3.5355339059327378 L 50 50 L 55 50 M -2.2414386804201336 1.2940952255126037 L -3.5355339059327378 -3.5355339059327378 L 1.2940952255126037 -2.2414386804201336 M -2.5 0 L 2.5 0 M 0 2.5 L 0 -2.5');
  });
});
